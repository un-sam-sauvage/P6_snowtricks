 ...
 */
final class Version20230713124426 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_885DBAFA5E237E06 ON posts (name)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_885DBAFA5E237E06 ON posts');
